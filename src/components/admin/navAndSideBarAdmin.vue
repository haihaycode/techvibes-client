<template>
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <router-link to="/admin" class="flex ms-2 md:me-24" style="background-color: white; ">
                        <span>
                            <svg height="100%" class="text-gray-800 dark:text-white me-24 w-10" aria-hidden="true"
    ...
    <aside id="logo-sidebar"
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <router-link to="/admin"
                        ...
                        <span class="ms-3">Quản lý chung</span>
                    </router-link>
                </li>
                <li>
                ...
                <li>
                    <router-link to="/admin/roles"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Quản lý và phân quyền</span>
                    </router-link>
                </li>
                <li>
                    <router-link to="/admin/favorite"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 24 24">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Quản lý yêu thích</span>
                    </router-link>
                </li>
                <li>
        ...
        <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800"
            ...
            <div class="z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 hidden"
                id="language-dropdown" data-popper-placement="bottom"
                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(184px, 536px, 0px);">
                <ul class="py-1" role="none">
                    <li>
                        <a href="#"
