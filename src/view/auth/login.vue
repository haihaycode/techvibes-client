    ...
    <div class="flex h-screen">
        ...
        <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                ...
                <h1 class="text-sm font-semibold mb-6 text-gray-500 text-center">Chào mừng bạn đến với Techvibes ! Vui
                    lòng đăng nhập để tiếp tục</h1>
                ...
                <Form @submit="handleLogin" :validation-schema="schema" v-slot="{ errors }" class="space-y-4">
                    <div>
                    ...
                    <div>
                        <input type="checkbox" v-model="rememberMe"> Ghi nhớ tôi ?
                    </div>

                    <div>
                        <Button type="submit" :text="loading ? 'Đang xử lý...' : 'Đăng Nhập'" :loading="loading"
                ...
                <div class="mt-4 text-sm text-gray-600 text-center">
                    <p>Bạn chưa có tài khoản ? <router-link to="/register" class="text-black hover:underline">Đăng
                            ký tài khoản</router-link>
                    </p>
...
export default {
    ...
    methods: {
        ...
        async handleLogin(values) {
            ...
            try {
                const resp = await this.login({ user, rememberMe: this.rememberMe });
