    ...
    <div class="flex h-screen">
        ...
        <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                <h1 class="text-3xl font-semibold mb-6 text-black text-center">Techvibes </h1>
                <h1 class="text-sm font-semibold mb-6 text-gray-500 text-center">Nếu bạn chưa có tài khoản tại
                    Techvibes, hãy nhanh tay đăng ký để không bỏ lỡ những ưu đãi hấp dẫn và trải nghiệm mua sắm hàng đầu
                </h1>
                ...
                <Form @submit="handleRegister" :validation-schema="schema" v-slot="{ errors }" class="space-y-4">
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700">Tài khoản (email) </label>
                    ...
                    <div>
                        <label for="confirmPassword" class="block text-sm font-medium text-gray-700">Xác nhận mật
                            khẩu</label>
                    ...
                    <div>
                        <Button type="submit" :text="loading ? 'Đang xử lý...' : 'Đăng Ký'" :loading="loading"
                ...
                <div class="mt-4 text-sm text-gray-600 text-center">
                    <p>Bạn đã có tài khoản ? <router-link to="/login" class="text-black hover:underline">Đăng
